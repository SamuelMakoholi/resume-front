    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-black mb-2 font-heading">Welcome Back</h1>
          <p className="text-black">Sign in to continue building amazing resumes</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-[rgb(var(--primary))] focus:ring-[rgb(var(--primary))] border-gray-300 rounded"
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-black">
                  Remember me
                </label>
              </div>
              <Link href="/forgot-password" className="text-sm text-[rgb(var(--primary))] hover:text-[rgb(var(--primary-dark))]">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-black hover:bg-gray-50">
          ...
          <div className="mt-6 text-center">
            <p className="text-black">
              ...
              <Link href="/register" className="text-[rgb(var(--primary))] hover:text-[rgb(var(--primary-dark))] font-medium">
                Create one here
              </Link>
            </p>
          </div>
